...
const META = {
  ...
  "3mpq-scout":      { group: "Research & content", order: 0, type: "content", role: "Scouts live trends + market need. First step on new projects.", writes: "research/TRENDS.md" },
  "3mpq-researcher": { group: "Research & content", order: 1, type: "content", role: "Trends, competitors, direction.", writes: "research/*.md" },
  "3mpq-economist":  { group: "Research & content", order: 2, type: "content", role: "Pricing and unit economics.", writes: "pricing-brief.md" },
  "3mpq-copywriter": { group: "Research & content", order: 3, type: "content", role: "Writes the copy.", writes: "content/copy.json" },
  "3mpq-humanizer":  { group: "Research & content", order: 4, type: "content", role: "Rewrites AI drafts into plain human text.", writes: "rewritten draft" },
