...
export function Hero() {
  ...
  return (
    ...
    >
      <div className="mx-auto grid h-full w-full max-w-[1600px] grid-cols-1 items-center gap-12 px-6 md:px-8 lg:px-10 lg:grid-cols-2 lg:gap-16" style={{ paddingTop: "97px" }}>
        {/* 3D Book */}
        <div
