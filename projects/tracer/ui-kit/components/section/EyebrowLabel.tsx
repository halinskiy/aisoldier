...
export function EyebrowLabel({
  ...
  return (
    <span
      ...
      className={cn(
        "inline-flex w-fit self-start items-center font-sans text-[14px] font-medium uppercase leading-[1.5] py-1",
        "tracking-[0.062em]",
        accent ? "text-[var(--color-accent)]" : "text-[var(--color-text)]",
        pill &&
          "rounded-full border border-[var(--color-border)] bg-[var(--color-bg)]/60 px-3 backdrop-blur-[2px]",
        className,
      )}
      style={style}
    >
