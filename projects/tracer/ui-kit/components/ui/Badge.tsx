...
const tones: Record<Tone, string> = {
  ...
  // Accent: accent fill. Text colour resolves through
  // `--color-accent-contrast`. Projects override the variable to match
  // their accent luminance. Default falls back to near-black which is
  // correct for orange-family accents. Blue or deep accents should set
  // the variable to white.
  accent:
    "bg-[var(--color-accent)] border border-[var(--color-accent)] text-[var(--color-accent-contrast,#1e1e1e)]",
